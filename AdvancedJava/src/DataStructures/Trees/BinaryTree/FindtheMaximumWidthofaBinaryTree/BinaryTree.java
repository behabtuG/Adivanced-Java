package DataStructures.Trees.BinaryTree.FindtheMaximumWidthofaBinaryTree;
...
//Assign data to the new node, set left and right children to null
    ...
    public int findMaximumWidth() {
        ...
        //Check if root is null, then width will be
        if (root == null) {
            System.out.println("Tree is empty");
            return 0;
        } else {
            //Addroot node to queue as it represents the first level
            queue.add(root);
            while (queue.size() != 0) {
