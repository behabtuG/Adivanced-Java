package DataStructures.Queue.PriorityQueue.DijkstrasAlgorithmforAdjacencyListRepresentationGreedyAlgo7;
...
public class ShortestPath {
    ...
    void dijkstra(int graph[][], int src) {
        ...
        // sptSet[i] will true if vertex i is included in the shortest path tree or shortest distance from src
        // to i is finalized
